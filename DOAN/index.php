...
<div class="container" style="margin-top:30px; z-index:1;">
                            ...
                            <form action="create-post.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group "> 
                                    <div class="form-row align-items-center">
                                        <div class="col-auto my-1" style="border-right:1px solid #ccccb3;">
                                            <label for="content " style="padding:10px;">Create new post</label>
                                        </div>
                                        <div class="col-auto my-1"style="border-right:1px solid #ccccb3;">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-block" style=" background-color:#009999;">POST</button> 
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="overflow-auto  card" style="overflow-y:auto;  height:300px; background-color: transparent;">
                                    ...
                                    <?php $get_test =  getNotificationsLikeByPost($currentUser['id']); ?>
                                            ...
                                            <div id="toast4" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
                                                ...
                                                <a href="show-all-comment.php?postId=<?php echo $gt['postId'] ;?>" style="text-decoration: none; color:black;"> (News <?php echo $gt['postId']; ?>) <?php echo $gt['title']; ?></a>
                                                </div>
                                            </div>
                                ...
                                <div class=" " style="background-color: transparent;">
                                    <div class="card-body">
                                        ...
                                        <div class="overflow-auto  card" style="overflow-y:auto;  height:300px; background-color: transparent;">
                                            ...
                                            <div class="card-body" >
                                                <?php foreach($getListFriends as $LF): ?>
                                                <div class="" style="  font-weight:bold; height-line:3px; word-wrap: break-word; font-size:16px; padding:10px 0 0 0; margin-bottom:5px;" >
                                                    <a style="text-decoration: none; color:black; margin-left:5px;" href="chat.php?id=<?php echo $LF['id']; ?>" > 
                                                        <img style= "width: 35px; height:35px;" class="rounded-circle" src="<?php echo $LF['avatar'];?>" >                                                                  
                                                        <?php echo $LF['displayName'];  ?>   
                                                    </a>                                                 
                                                </div>         
...
<?php else: ?>
                ...
                <!-- <div class="" style=" margin-top:100px; color:blue;">
                    <p><h1 align="center">Welcome My Website</h1></p>
