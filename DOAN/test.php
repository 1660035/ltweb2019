<?php
    ...
    $postUserF = getUserNewFeedsFri($userId);
    $postUserS = getUserNewFeedsStr($userId);
    ...
    <div class="row">
        <div class="col-md-9 col-sm-9">
            <div class="row">
                <div class="col-12">
                    <div class="card" >                        
                        <form action="create-post-my.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group green-border-focus"> 
                                ...
                                <textarea name="content" id="content"  class="form-control"  rows="6" placeholder="What do you think? What do you think? What do you think?"></textarea>
                            </div>                           
                                                    ...
                                                    <div class=" ">
                                                        <script src="js.js"></script>                                        
                                                            <?php $listCurrentUserLike = checkLikeFromUser($post['stt'], $currentUser['id']); ?>                                            
                                                                ...
                                                                <form action="comment-my.php" method="POST" enctype="multipart/form-data">
            ...
            <?php else: ?>
                ...
                <?php if(checkUserInFri($userId, $currentUser['id'])): ?>
                <?php foreach ($postUserF as $post):    ?>                                    
                <div class="col-12">
