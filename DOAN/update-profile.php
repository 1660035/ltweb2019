...
?>
<?php if($success): ?>
<?php header('Location:test.php?id=' . $currentUser['id']); ?>
ob_end_flush();
<?php else: ?>
...
<div class="container" style="margin-top:70px;" >
            ...
            <form action="" method="POST" enctype = "multipart/form-data">    
                    <div class="login-form" style="background:url('img/1234.jpg');">
                        ...
                        <button type="submit" class="log-btn"  style="color:black; border-radius:15px; background-color:#009999;">APPLY</button>                            
                    </div>
            </form>
