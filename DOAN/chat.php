                ...
                <?php foreach($getListFriends as $gt): ?>
                    ...
                    <div id="toast9" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
                        <div class="toast-header">
                            ...
                            <strong style="margin-left:5px; font-size:14px;" class="mr-auto"><?php echo $gt['displayName']; ?></strong>    
                                        <form action="delete-mess.php" method="POST" enctype="multipart/form-data">                                
                                            <input type="hidden" class="form-control-file " id="test2" name="test2" style="display:none;" value="<?php echo $gt['id'];?>"> 
                                                                
                                            
                                                
                                                                    <button type="test1" class="ml-2 mb-1 close" >
                    ...
                    <div id="toast9" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
                        ...
                        <div class="toast-body" id="sam" name="sam" style="font-size:12px;">
                            ...
                            <a style="text-decoration: none;" href="chat.php?id=<?php echo $gt['id']; ?>" name="chatchat" id="chatchat " >NULL</a>
