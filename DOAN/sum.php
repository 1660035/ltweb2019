                    ...
                    <!-------AVATAR------>
                        <div class="col-md-3 col-sm-3" style="z-index:3;">                        
                            <div style="height:210px;  " class="d-flex align-items-end">
                                <img  style= "max-width:100%;  max-height: 100%; border:2px solid white; " class="rounded-circle" src="<?php echo $profile['avatar'];?>" >
                            </div>                           
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-12" style="height:87px; background:white; ">
                                    <ul  class="d-flex  flex-row bd-highlight "  style="  margin-left:0px; height:100%;">
                                        <!------DISPLAYNAME-------->
                                        <?php if($profile['id'] == $currentUser['id']): ?>
                                        <li align="center" class="list-group-item  p-3 bd-highlight  "  style="border-bottom:0; border-right:0; background:white;  color:black; height:100%; width:280px; font-weight:bold;">DisplayName  <a href="update-profile.php"><i class="fa fa-pencil "></i></a><br>
                                                    <p align="center" style="font-weight:bold; color:red; font-size:22px;"><?php echo $profile['displayName'];?></p>
                                        </li>
                                        <?php else: ?>
                                        <li align="center" class="list-group-item p-3 bd-highlight " style="border-bottom:0; border-right:0; background:white; color:black; height:100%; width:290px; font-weight:bold; font-size:20px;">DisplayName<br>
                                                    <p align="center" style="font-weight:bold; color:red; font-size:22px;"><?php echo $profile['displayName'];?></p>
                                        </li>
                                        <?php endif; ?>
                                        <!----------FOLLOWING---------->
                                        ...
                                        <!----------FOLLOWER---------->
                                        <li align="center" class="list-group-item border-1 " style="border-bottom:0; background:white; color:black; height:100%; width:165px; font-weight:bold;">Followers<br>
                                        ...
                                        <li align="center" class="list-group-item d-flex align-items-center  p-3 bd-highlight dropdown" style="border-bottom:0; border-left:0; background:white; float:right; margin:0 0 0 0;  height:100%;">
                                                        ...
                                                        <?php if ($isFollower && $isFollowing): ?>
                                                            ...
                                                            <i class="fa fa-check"> Fllowing</i> 
                                                            </a>
                                                            ...
                                                            <?php if($isFollowing && !$isFollower): ?>
                                                                ...
                                                                <form action="remove-friend.php" method="POST">
                                                                    ...
                                                                    <button type="submit" class="btn btn-danger">
                                                                        <i class="fa fa-times"> Delete Request</i> 
                                                                    </button>
                                                                </form>
                                                            <?php endif; ?>
                                                            ...
                                                            <?php if(!$isFollowing && !$isFollower): ?>
                                                                ...
                                                                <form action="add-friend.php" method="POST">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary">
                                                                        <i class="fa fa-rss"> Send Request</i> 
                                                                    </button>
                                                                </form>
                                                            <?php endif; ?>
