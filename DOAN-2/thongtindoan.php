...
<!---- NEW-FEEDS ----->
    ...
    <div class="" style="margin:500px 0 0 500px; background:red; height:300px; width:300px; z-index:2; ">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row " style="">
                            <div class="col-12">
                                    ...
                                    <div  id="myDIV" style="display:none; background:red; height:200px; ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="overflow-auto  card" style="overflow-y:auto;  height:300px; background-color: transparent;">
                                            ...
                                            <div class="card-body" >
                                                ...
                                                <div class="card" style="font-weight:bold; height-line:3px; word-wrap: break-word; font-size:16px; padding:10px 0 0 0; margin-bottom:5px;" >
                                                    <a style="margin-left:5px;" onclick="myFunctionxx()"> 
