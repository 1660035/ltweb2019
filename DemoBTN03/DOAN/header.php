    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-expand-lg    "  style="background:url('img/posts/neon_backlight_wall_127757_3840x2400.jpg');">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="font-size:16px; " href="thongtindoan.php"><p style="color:white;">1660035 - 1660035</p></a>
          <a class="navbar-brand" style="font-size:16px; " href="thongtindoan.php"><p style="color:white;">Main Page</p></a>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <?php else: ?>
              ...
              <li class="nar-item dropdown">
                <button style="margin:5px 0 0 5px;" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
